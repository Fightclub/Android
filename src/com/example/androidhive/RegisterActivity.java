...
import com.channing.fighclub.JsonUtil;
			...
			public void onClick(View view) {
				...
				if (errorMessage != JsonUtil.JSON_OBJECT_FAIL) {
					...
					try {
		                ...
		                String fn = prefs.getString(Constants.FIRST_NAME, "debug failed");
		                String ak = prefs.getString(Constants.API_KEY_KEY, "debug failed");
						Toast.makeText(getApplicationContext(), 
		        				fn + "registered! " + ak, 1000).show();
						finish();
